(function() {
  ...
  style.textContent = `
    ...
    #nauxilia-btn svg { width: 26px; height: 26px; }
    #nauxilia-box {
    ...
    .nauxilia-msg.user {
      background: #1A2640; color: #fff; align-self: flex-end;
    }
    .nauxilia-msg.typing { color: #9CA3AF; font-style: italic; }
    #nauxilia-input-area {
    ...
    #nauxilia-send {
      background: #1A2640; color: #C9A96E; border: none;
      border-radius: 8px; padding: 8px 14px;
      cursor: pointer; font-size: 18px;
    }
    #nauxilia-send:hover { background: #243555; }
    #nauxilia-powered {
  ...
  document.body.insertAdjacentHTML('beforeend', `
    <button id="nauxilia-btn" aria-label="Ouvrir l'assistant">
      <svg viewBox="0 0 24 24" fill="none" stroke="#C9A96E" stroke-width="2">
  ...
  function toggleChat() {
    ...
    if (isOpen && !greeted) {
      greeted = true;
      addMsg("Bonjour ! Je suis l'assistant de FAIR. Comment puis-je vous aider ? (I can also answer in English, Arabic, Ukrainian or any language)", 'bot');
    }
